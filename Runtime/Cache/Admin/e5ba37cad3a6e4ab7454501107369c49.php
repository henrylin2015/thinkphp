...
<html>
    ...
    <body>
        <table height="100%" cellspacing=0 cellpadding=0 width=170 
               background=/tp/Public/static/admin/img/menu_bg.jpg border=0>
               <tr>
                <td valign=top align=middle>
                    ...
                    <table cellspacing=0 cellpadding=0 width=150 border=0>
                        ...
                        <tr height=22>
                            <td style="padding-left: 30px" background=/tp/Public/static/admin/img/menu_bt.jpg onclick=expand(1) ><a 
                    ...
                    <table id=child1  cellspacing=0 cellpadding=0 
                        ...
                        <tr height=20>
                            <td align=middle width=30><img height=9 
                                                           src="/tp/Public/static/admin/img/menu_icon.gif" width=9></td>
                    ...
                    <table cellspacing=0 cellpadding=0 width=150 border=0>
                        <tr height=22>
                            <td style="padding-left: 30px" background=/tp/Public/static/admin/img/menu_bt.jpg><a 
